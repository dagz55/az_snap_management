...
error_log_file = os.path.join(log_dir, f"error_log_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}.txt")
...
def validate_snapshots(snapshot_list_file):
    ...
    # Create summary table (reverted to original format)
...
if __name__ == "__main__":
    snapshot_list_file = "snap_rid_list.txt"
